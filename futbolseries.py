...
def main_futbol(master):
    ...
    img1 = tk.PhotoImage(file=resource_path('figures/2_2_additions.png'))
    img2 = tk.PhotoImage(file=resource_path('figures/2_2_extra.png'))
...
def main_series(master):
    ...
    Args:
        master (tkinter.Tk): window of the general game.
    """
    top_series = MainTopLevel(master,'ESUN')
